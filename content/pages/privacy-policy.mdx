...
Welcome to Nano Banana 2, the **AI-powered image editing platform** designed to help you transform your images with natural language prompts. At Nano Banana 2, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.
...
2. **Usage Details**
   - **What We Collect**: Information about how you use Nano Banana 2, including your interactions, features accessed, and usage frequency.
...
6. **Uploaded Images**
   - **What We Collect**: Images you upload for AI editing purposes.
   - **Purpose**: To process your editing requests. Uploaded images are temporarily stored and automatically deleted after processing.
...
**Website**: [nano-banana2.pro](https://nano-banana2.pro)
**Email**: [support@nano-banana2.pro](mailto:support@nano-banana2.pro)

By using Nano Banana 2, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!

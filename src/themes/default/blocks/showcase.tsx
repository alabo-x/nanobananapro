      ...
      <div className="container space-y-8 md:space-y-12">
        ...
        <ScrollAnimation delay={0.2}>
          <div className="relative mx-auto max-w-3xl">
            {/* Navigation Arrows - Outside the card, hidden on mobile */}
            <button
              onClick={goToPrevious}
              disabled={isAnimating}
              className="absolute -left-14 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full bg-background/80 backdrop-blur-sm border shadow-md hover:bg-background transition-colors disabled:opacity-50 hidden md:flex items-center justify-center"
            ...
            <button
              onClick={goToNext}
              disabled={isAnimating}
              className="absolute -right-14 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full bg-background/80 backdrop-blur-sm border shadow-md hover:bg-background transition-colors disabled:opacity-50 hidden md:flex items-center justify-center"
            ...
            {/* Main Card Container */}
            <div
              className="rounded-2xl border bg-card p-4 md:p-6 shadow-lg"
            ...
            >
              ...
              {/* Image Container - 1080x780 ratio */}
              <div className="relative aspect-[1080/780] overflow-hidden rounded-xl border bg-muted/30">
                <div
                  key={animationKey}
                  className={cn(
                    "absolute inset-0",
